...
class GrunnlagSerDesTest {
    ...
    fun testGrunnlagSerdes() {
        val barn =
            Barn(Rolle.SOKNADSBARN, LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(2022, Month.JANUARY, 31), 1)
        ...
        val barnetilsynMedStonad = BarnetilsynMedStonad(
            ...
            LocalDate.of(9999, Month.DECEMBER, 31),
            1,
            StonadType.BIDRAG.name,
            "tilsyn"
        )
        val barnIHusstand =
            BarnIHusstand(1.0, LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31))
        val barnInfo = BarnInfo(
            LocalDate.of(2022, Month.JANUARY, 1),
            LocalDate.of(9999, Month.DECEMBER, 31),
            "12345678910",
            "Navn Navnesen",
        ...
        val bostatusBP =
            BostatusBP(BostatusKode.ALENE, LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31))
        val deltBosted =
            DeltBosted(1, false, LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31))
        val faktiskUtgift = FaktiskUtgift(
            LocalDate.of(2022, Month.JANUARY, 1),
            LocalDate.of(9999, Month.DECEMBER, 31),
            1,
        ...
        val nettoSaertilskudd = NettoSaertilskudd(
        ...
        val saerfradrag = Saerfradrag(
            SaerfradragKode.INGEN,
            LocalDate.of(2022, Month.JANUARY, 1),
            LocalDate.of(9999, Month.DECEMBER, 31)
        )
        val saksbehandlerInfo = SaksbehandlerInfo("12345678910", "Navn Navnesen")
        val samvaersklasse =
            Samvaersklasse(1, "01", LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31))
        ...
        val sjablon =
            Sjablon("navn", "verdi", LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31))
        val skatteklasse = Skatteklasse(1, LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31))
        val soknadInfo =
            SoknadInfo(LocalDate.of(2020, Month.JANUARY, 25), LocalDate.of(2020, Month.JANUARY, 25), "12345678")
        ...
        val inntekterInntektgrunnlag = listOf(
            Inntektgrunnlag(
                "12345678910",
                LocalDate.of(2022, Month.JANUARY, 1),
                LocalDate.of(9999, Month.DECEMBER, 31),
        ...
        val inntekterSkattegrunnlag = listOf(
            Skattegrunnlag(
                "12345678910",
                2022,
                listOf(SkattegrunnlagPost(InntektType.SKATTEGRUNNLAG_SKE.name, BigDecimal.valueOf(15000)))
            )
        )

        val inntekt = Inntekt(
            Rolle.BIDRAGSPLIKTIG,
            InntektType.LONN_TREKK,
        ...
        val inntektUtvidetBarnetrygd = InntektUtvidetBarnetrygd(
            false,
            Rolle.BIDRAGSPLIKTIG,
        ...
        val kapitalinntektBarn = KapitalinntektBarn(
            1,
            Rolle.SOKNADSBARN,
            InntektType.KAPITALINNTEKT_EGNE_OPPLYSNINGER,
            BigDecimal.valueOf(600000),
        ...
        val maksBidragPerBarn = MaksBidragPerBarn(
            BigDecimal.valueOf(1000),
            BigDecimal.valueOf(1000),
            BigDecimal.valueOf(1000),
            1,
        ...
        val maksGrense25Inntekt = MaksGrense25Inntekt(
            BigDecimal.valueOf(1000),
            BigDecimal.valueOf(1000),
            BigDecimal.valueOf(1000),
            BigDecimal.valueOf(1000),
        ...
        val tilleggsbidrag = Tilleggsbidrag(
            BigDecimal.valueOf(1000),
            BigDecimal.valueOf(1000),
            BigDecimal.valueOf(1000),
            BigDecimal.valueOf(1000),
        ...
        val sluttberegningBBM = SluttberegningBBM(
            1,
            BigDecimal.valueOf(1000),
            BigDecimal.valueOf(1000),
            "resultatKode",
        ...
        grunnlagListe.add(Grunnlag("Referanse", GrunnlagType.KAPITALINNTEKT_BARN, kapitalinntektBarn))
        ...
        assertEquals(6, deserializedGrunnlag.filter { grunnlag -> grunnlag.innhold is Inntekt }.size)
        assertEquals(1, deserializedGrunnlag.filter { grunnlag -> grunnlag.innhold is Kapitalinntekt }.size)
        assertEquals(1, deserializedGrunnlag.filter { grunnlag -> grunnlag.innhold is KapitalinntektBarn }.size)
        ...
        assertEquals(4, inntektGrunnlag.filter { inntektsgrunnlag -> inntektsgrunnlag is Inntektgrunnlag }.size)
