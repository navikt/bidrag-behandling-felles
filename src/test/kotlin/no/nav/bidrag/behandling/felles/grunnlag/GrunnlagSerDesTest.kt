...
class GrunnlagSerDesTest {
  ...
  fun testGrunnlagSerdes() {
    ...
    val forholdsmessigFordeling = ForholdsmessigFordeling(LocalDate.of(2022, Month.JANUARY, 1),LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31), "FO", LocalDate.of(2022, Month.JANUARY, 1), "1", "N", "12345678901", BigDecimal.valueOf(0), BigDecimal.valueOf(5000), BigDecimal.valueOf(3000), "AA", "AA")
    ...
    val bPsAndelUnderholdskostnad = BPsAndelUnderholdskostnad(1, BigDecimal.valueOf(5000), 50.0, listOf("referanse1", "referanse2"), LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31))
