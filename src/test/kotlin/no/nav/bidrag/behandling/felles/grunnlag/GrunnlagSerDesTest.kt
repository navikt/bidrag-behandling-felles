...
class GrunnlagSerDesTest {
  ...
  fun TestGrunnlagSerdes() {
    ...
    val barn = Barn(Rolle.SB, LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(2022, Month.JANUARY, 31), 1)
    val barnetillegg = Barnetillegg(Rolle.BM, 1, BigDecimal.valueOf(1500), BigDecimal.valueOf(0.3), LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31))
    ...
    val bostatus = Bostatus(Rolle.SB, LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31), BostatusKode.MED_FORELDRE, 1)
    ...
    val gebyrfritak = Gebyrfritak(LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(2022, Month.MARCH, 1), true, "kode", BigDecimal.valueOf(432), Rolle.BP)
    ...
    val sivilstand = Sivilstand(Rolle.BP, LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31), SivilstandKode.ENSLIG, "beskrivelse")
    ...
    val inntekt = Inntekt(Rolle.BP, InntektType.LONN_TREKK, BigDecimal.valueOf(600000), true, LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31), emptyList())
    val inntektBarn = InntektBarn(1, Rolle.SB, InntektType.LONN_TREKK, BigDecimal.valueOf(600000), true, LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31), inntekterInntektgrunnlag)
    val inntektUtvidetBarnetrygd = InntektUtvidetBarnetrygd(false, Rolle.BP, InntektType.UTVIDET_BARNETRYGD, BigDecimal.valueOf(600000), true, LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31), inntekterInntektgrunnlag)
    val skatteInntekt = Inntekt(Rolle.BP, InntektType.SKATTEGRUNNLAG_SKE, BigDecimal.valueOf(600000), true, LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31), inntekterSkattegrunnlag)
    ...
    val bPsAndelSaertilskudd = BPsAndelSaertilskudd(BigDecimal.valueOf(1000), BigDecimal.valueOf(1000), BigDecimal.valueOf(1000), BigDecimal.valueOf(1000), BigDecimal.valueOf(1000), 50.0, 1, listOf("referanse1", "referanse2"), LocalDate.of(2022, Month.JANUARY, 1), LocalDate.of(9999, Month.DECEMBER, 31))
